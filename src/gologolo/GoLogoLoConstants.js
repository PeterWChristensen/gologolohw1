export const GoLogoLoDefaults = {
    ...
    GOLOGOLO_DEFAULT_BORDER_STYLE: "none",
...
export const GoLogoLoGUIId = {
    ...
    GOLOGOLO_BORDER_STYLE_GROUP: "gologolo_border_style",
    GOLOGOLO_BORDER_STYLE_RADIO_BUTTON_NONE: "gologolo_border_style_radio_button_none",
    GOLOGOLO_BORDER_STYLE_RADIO_BUTTON_NONE_LABEL: "gologolo_border_style_radio_button_none_label",
    GOLOGOLO_BORDER_STYLE_RADIO_BUTTON_SOLID: "gologolo_border_style_radio_button_solid",
    GOLOGOLO_BORDER_STYLE_RADIO_BUTTON_SOLID_LABEL: "gologolo_border_style_radio_button_solid_label",
...
export const GoLogoLoText = {
    ...
    GOLOGOLO_BORDER_STYLE_RADIO_BUTTONS_TEXT: "gologolo_border_style_radio_buttons",
    GOLOGOLO_BORDER_STYLE_RADIO_BUTTON_NONE_TEXT: "gologolo_border_style_radio_button_none_text",
    GOLOGOLO_BORDER_STYLE_RADIO_BUTTON_SOLID_TEXT: "gologolo_border_style_radio_button_solid_text",
    ...
    GOLOGOLO_TEXT_INPUT_MODAL_ENTER_BUTTON_TEXT: "appster_text_input_modal_enter_button_text",
    GOLOGOLO_TEXT_INPUT_MODAL_CANCEL_BUTTON_TEXT: "appster_text_input_modal_cancel_button_text",
...
export const GoLogoLoCallback = {
    ...
    GOLOGOLO_PROCESS_BORDER_NONE: "processBorderNone",
    GOLOGOLO_PROCESS_BORDER_SOLID: "processBorderSolid",
